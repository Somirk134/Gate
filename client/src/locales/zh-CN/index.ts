...
const messages: LocaleMessages<Record<string, unknown>> = {
    ...
    about: {
        ...
        summaryBody: "Gate 将 Rust 服务端、Tauri 桌面客户端、认证、心跳、监控视图和 Docker 部署模板组合在一起，让团队可以用自己控制的公网入口访问本地开发机、内网服务或私有系统。",
        ...
        creditsKicker: "构建与许可",
        acknowledgements: "致谢",
        creditLine: "基于 Tauri、Vue 3、Rust 与 Naive UI 构建；图标来自 Lucide。感谢开源社区为 Gate 提供可靠的基础设施。",
