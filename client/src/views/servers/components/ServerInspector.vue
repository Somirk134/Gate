  ...
  <div class="server-inspector" :style="colorVars">
    ...
    <div class="server-inspector__body">
      ...
      <div class="server-inspector__group">
        <div class="server-inspector__group-title">实时统计</div>
      ...
      <!-- Mini Chart -->
      <div class="server-inspector__group">
        <div class="server-inspector__group-title">流量趋势</div>
      ...
      <!-- 基础信息 -->
      <div class="server-inspector__group">
        <div class="server-inspector__group-title">基础信息</div>
        ...
        <div class="server-inspector__row">
          ...
          <span class="server-inspector__value">
            <GIcon :name="server.settings.autoConnect ? 'check' : 'close'" :size="12" :class="server.settings.autoConnect ? 'on' : 'off'" />
      ...
      <!-- 资源 -->
      <div class="server-inspector__group">
        <div class="server-inspector__group-title">资源占用</div>
        <div class="server-inspector__row">
      ...
      <!-- 累计 -->
      <div class="server-inspector__group">
        <div class="server-inspector__group-title">累计</div>
        <div class="server-inspector__row">
      ...
      <!-- 健康 -->
      <div class="server-inspector__group">
        <div class="server-inspector__group-title">健康</div>
        <div class="server-inspector__row">
          <span class="server-inspector__label">状态</span>
          <span class="server-inspector__value" :style="{ color: healthColor(server.health.overall) }">
            {{ healthLabel }}
          </span>
        </div>
        <div class="server-inspector__row">
      ...
      <div v-if="server.tags.length" class="server-inspector__group">
        <div class="server-inspector__group-title">标签</div>
      ...
      <!-- 最近日志 -->
      <div class="server-inspector__group">
        <div class="server-inspector__group-title">最近日志</div>
        <div class="server-inspector__logs">
          ...
          >
            <span class="server-inspector__log-level" :class="`server-log-line__level--${log.level}`">
              {{ log.level }}
            </span>
