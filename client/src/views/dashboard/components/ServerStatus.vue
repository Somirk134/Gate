...
const connectedCount = computed(() =>
  props.servers.filter((s) => s.status === "online").length,
)
...
.server-status__info-value--good { color: var(--color-success); }
.server-status__info-value--warn { color: var(--color-warning); }
.server-status__info-value--bad { color: var(--color-error); }
