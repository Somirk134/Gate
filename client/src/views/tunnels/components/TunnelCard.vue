...
<template>
  <div
    class="tunnel-row"
    :class="[`tunnel-row--${tunnel.status}`, { 'tunnel-row--active': active }]"
    :style="colorVars"
...
.tunnel-row__bar--running {
  background: var(--status-online);
}
.tunnel-row__bar--starting {
  background: var(--status-starting);
}
.tunnel-row__bar--connecting {
  background: var(--status-connecting);
}
.tunnel-row__bar--restarting {
  background: var(--status-connecting);
}
.tunnel-row__bar--stopping {
  background: var(--status-warning);
}
.tunnel-row__bar--error {
  background: var(--status-error);
}
.tunnel-row__bar--disconnected {
  background: var(--status-warning);
}
.tunnel-row__bar--stopped {
  background: var(--status-offline);
}
.tunnel-row__bar--offline {
  background: var(--status-offline);
}
</style>
