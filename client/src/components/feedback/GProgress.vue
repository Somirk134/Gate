  ...
  <div class="g-progress" :class="[`g-progress--${size}`]">
    ...
    <div class="g-progress__track">
      <div
        ...
        :class="[
          `g-progress__bar--${variant}`,
          { 'g-progress__bar--indeterminate': indeterminate },
        ]"
...
.g-progress--sm .g-progress__track {
  height: 3px;
}
.g-progress--md .g-progress__track {
  height: 6px;
}
...
.g-progress__bar--primary {
  background: var(--color-primary);
}
.g-progress__bar--success {
  background: var(--color-success);
}
.g-progress__bar--warning {
  background: var(--color-warning);
}
.g-progress__bar--error {
